...
ActiveRecord::Schema.define(version: 20170621130141) do
  ...
  create_table "comment_questions", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["question_id"], name: "index_comment_questions_on_question_id"
    t.index ["user_id"], name: "index_comment_questions_on_user_id"
  end
